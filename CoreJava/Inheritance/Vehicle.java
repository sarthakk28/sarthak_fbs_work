class Vehicle {
	...
	int engineCapacity;
	Vehicle() {
		this.vehicleNo = "MH12AB124" ;
		this.brand = "Honda";
		this.model = "City";
		this.color = "White";
		this.fuelType = "Petrol";
		this.engineCapacity = 1467;
	}
...
class TestVehicle {
	...
	public static void main(String[] args) {
	    ...
	    Vehicle v2 = new Vehicle ("MH14XY523","Hyundai","Creta","Black","Diesel",1493);
		v2.display();
		...
		Car c2 = new Car ("MH31GH1111","Maruti","Swift","Red","Petrol",1197,5,286.0,"Manual");
		c2.display();
		...
		Truck t2 = new Truck ("MH12TR1234", "Tata", "LPT 1512", "White", "Diesel", 4200, 7.0, 2, false);
		t2.display();
		...
		Bike b2 = new Bike ("MH31BK2498","Bajaj","Pulsar 150","Black","Petrol",150,70,true,5);
		b2.display();
	}
