...
class TestAnimal {
	public static void main (String [] args) {
		...
		Animal a2 = new Animal("Ella",12,"Elephant","Grasslands",5400.0,"Herbivore");
		a2.display();
		...
		Dog d2 = new Dog ("Ella",12,"Elephant","Grasslands",5400.0,"Herbivore","Arabian Horse","Brown",150.0);
		d2.display();
		...
		Bird b2 = new Bird ("Ella",12,"Elephant","Grasslands",5400.0,"Herbivore",1.1,"Cone-shaped",false);
		b2.display();
		...
		Cat c2 = new Cat("Ella",12,"Elephant","Grasslands",5400.0,"Herbivore","Black","Green",2.8);
		c2.display();
