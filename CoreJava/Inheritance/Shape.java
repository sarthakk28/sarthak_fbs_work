...
class TestShape {
	public static void main (String [] args) {
		...
		Shape s2 = new Shape("Green",3,54,34,"XYZ");
		s2.display();
		...
		Circle c2 = new Circle ("Green",3,54,34,"XYZ",12,23,23);
		c2.display();
		...
		Triangle t2 = new Triangle ("Green",3,54,34,"XYZ",12,32,43);
		t2.display();
		...
		Rectangle r2 = new Rectangle ("Green",3,54,34,"XYZ",11,12,13);
		r2.display();
	}
}