...
class TestBank {
	...
	public static void main(String[] args) {
	    ...
	    b1 = new BankAccount ("Aniket",143,20000,8976558,3475637,9876543);
		b1.display();
		...
		b1 = new SavingAccount ("sarthak",235,40000,4567854,456786,345567,60000,9,20000);
		b1.display();
		...
		b1 = new LoanAccount ("chaitanya",101,30000,34567,76543,234567,80000,10,30000);
		b1.display();
		System.out.println();
		...
		b1 = new CurrentAccount ("Ketan",111,23456,67890,56789,90000,20000,"Dairy",89588);
		b1.display();
