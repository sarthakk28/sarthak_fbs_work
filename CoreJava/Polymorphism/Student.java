...
class TestStudent {
    ...
    public static void main(String[] args) {
        ...
        s1 = new SchoolStudent (5,"om",20,"b",12,"Math","A");
        s1.display();
        
        System.out.println();
        
        s1 = new ResearchScholar ();
        s1.display();
        
        System.out.println();
        
        s1 = new ResearchScholar (6,"chaitanya",24,"a","abc","xyz",91);
        s1.display();
        ...
        s1 = new CollegeStudent (8,"Pramod",20,"A","BCA",5,9);
        s1.display();
