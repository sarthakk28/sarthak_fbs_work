...
class TestLibraryItem {
	public static void main (String [] args) {
		...
		l1 = new LibraryItem ("Introduction to Java Programming","Pearson Education",2021,"English","Programming","B101");
		l1.display();
		...
		l1 = new Book ("Database System Concepts","McGraw Hill",2020,"English","Database","B102","Herbert Schildt","978-1260440218","11th Edition");
		l1.display();
		...
		l1 = new NewsPaper("Database System Concepts","McGraw Hill",2020,"English","Database","B102","2022-12-3","Emily Johnson","AI Revolutionizes Software Development");
		l1.display();
		...
		l1 = new Magazine ("Database System Concepts","McGraw Hill",2020,"English","Database","B102",42,"Monthly","Emily Johnson");
		l1.display();
	}
}
